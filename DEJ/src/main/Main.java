...
public class Main implements KeyListener {
	...
	public static void setup() {
		...
		Point n = new Point(40, 80);
		Point o = new Point(50, 80);
		Point p = new Point(60, 80);
		Point q = new Point(40, 90);
		Point r = new Point(50, 90);
		Point s = new Point(10, 100);
		Point t = new Point(30, 100);
		Point u = new Point(40, 100);
		Point v = new Point(50, 100);
		...
		leftStart.add(new Segment(e, a, Color.GREEN, Color.CYAN, Color.WHITE));
		leftStart.add(new Segment(f, e, Color.GREEN, Color.CYAN, Color.WHITE));
		leftStart.add(new Segment(b, f, null, null, null));
		leftStart.add(new Segment(a, b, Color.GREEN, Color.CYAN, Color.WHITE));

		ArrayList<Segment> middleStart = new ArrayList<>();
		leftStart.add(new Segment(f, b, null, null, null));
		leftStart.add(new Segment(g, f, null, null, null));
		leftStart.add(new Segment(c, g, null, null, null));
		leftStart.add(new Segment(b, c, Color.GREEN, Color.CYAN, Color.WHITE));

		ArrayList<Segment> rightStart = new ArrayList<>();
		rightStart.add(new Segment(g, c, null, null, null));
		rightStart.add(new Segment(h, g, Color.GREEN, Color.CYAN, Color.WHITE));
		rightStart.add(new Segment(d, h, Color.GREEN, Color.CYAN, Color.WHITE));
		rightStart.add(new Segment(c, d, Color.GREEN, Color.CYAN, Color.WHITE));

		ArrayList<Segment> hallway = new ArrayList<>();
		hallway.add(new Segment(j, f, Color.GREEN, Color.CYAN, Color.WHITE));
		hallway.add(new Segment(k, j, null, null, null));
		hallway.add(new Segment(g, k, Color.GREEN, Color.CYAN, Color.WHITE));
		hallway.add(new Segment(f, g, null, null, null));
		...
		leftTriangle.add(new Segment(s, t, Color.MAGENTA, Color.CYAN, Color.WHITE));
		leftTriangle.add(new Segment(t, m, Color.MAGENTA, Color.CYAN, Color.WHITE));
		leftTriangle.add(new Segment(m, s, Color.MAGENTA, Color.CYAN, Color.WHITE));
		...
		level.add(new Sector(leftStart, 0, 80, Color.RED, Color.RED, true));
		level.add(new Sector(middleStart, 0, 80, Color.RED, Color.RED, true));
		level.add(new Sector(rightStart, 0, 80, Color.RED, Color.RED, true));
		level.add(new Sector(hallway, 0, 80, Color.RED, Color.RED, true));
		level.add(new Sector(leftRoom, 0, 80, Color.RED, Color.RED, true));
		level.add(new Sector(middleRoom, 0, 80, Color.RED, Color.RED, true));
		level.add(new Sector(rightRoom, 0, 80, Color.RED, Color.RED, true));

		level.add(new Sector(leftTriangle, 0, 80, Color.RED, Color.RED, false));
		level.add(new Sector(rightTriangle, 0, 80, Color.RED, Color.RED, false));
		level.add(new Sector(firstStep, 10, 80, Color.RED, null, false));
		level.add(new Sector(secondStep, 20, 80, Color.RED, null, false));
		level.add(new Sector(thirdStep, 30, 80, Color.RED, null, false));
